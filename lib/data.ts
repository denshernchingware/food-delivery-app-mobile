...
customizations: [
    ...
    { name: "Medium", price: 50, type: "size" },
    { name: "Large", price: 100, type: "size" },

    // Spice Levels
    { name: "No Spice", price: 0, type: "spice" },
    { name: "Mild", price: 0, type: "spice" },
    { name: "Medium", price: 0, type: "spice" },
    { name: "Hot", price: 0, type: "spice" },
    { name: "Extra Hot", price: 10, type: "spice" },

    // Crust (Pizza)
    { name: "Classic Crust", price: 0, type: "crust" },
    { name: "Thin Crust", price: 20, type: "crust" },
    { name: "Cheese Burst", price: 60, type: "crust" },
    { name: "Stuffed Crust", price: 70, type: "crust" },
    { name: "Whole Wheat Crust", price: 25, type: "crust" },

    // Bread (Burgers / Sandwiches)
    { name: "White Bread", price: 0, type: "bread" },
    { name: "Brown Bread", price: 10, type: "bread" },
    { name: "Whole Wheat Bread", price: 15, type: "bread" },
    { name: "Multigrain Bread", price: 20, type: "bread" },
    { name: "Sesame Bun", price: 15, type: "bread" },
